        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            ...
            <div className="space-y-6 col-span-2 lg:col-span-1">
              ...
              {product.has_sizes && product.productsizes?.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-sm font-semibold text-gray-900">
                      Size
                    ...
                    {selectedColor?.sizes.map((size) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setAvailableStock(size.remaining_qty);
                        }}
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    onClick={() =>
                      setQuantity(Math.min(quantity + 1, availableStock || 999))
                    }
                    disabled={quantity >= availableStock}
                    className="w-10 h-10 flex items-center justify-center bg-[#F3F4F6] rounded hover:bg-gray-200 disabled:opacity-50"
                  >
                    <Plus className="w-4 h-4" />
                  </button>
                </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="w-full bg-gray-100 text-[#02382A] py-4 rounded-lg font-semibold hover:bg-[#02382A] border border-[#02382A] hover:text-white transition-colors disabled:opacity-50"
                >
                  ADD TO BAG
                </button>
                <button
                  ...
                  className="w-full bg-[#02382A] text-white py-4 rounded-lg font-semibold hover:bg-[#F3F4F6] border border-[#02382A] hover:text-[#02382A] transition-colors disabled:opacity-50"
                >
                  BUY NOW
                </button>
              </div>
              ...
              <div className="border-t border-b border-gray-200 py-4 space-y-3">
                ...
                <div className="text-sm text-gray-600 text-center">
                  Return and Exchange Within Days
                </div>
              </div>
