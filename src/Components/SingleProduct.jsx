  ...
  return (
    <>
      <Helmet>
        <title>
          {product.meta_title ||
            `${product.name} – ₹${product.price} | YourBrand`}
        </title>
        <meta
          name="description"
          content={
        ...
        <meta
          ...
          content={
            product.keywords ||
            `${product.name}, ${product.SubCategoryModel?.name}, ethnic wear, india`
          }
        />
        ...
        <meta
          ...
          content={
            product.meta_description || product.description?.slice(0, 140)
          }
        />
