...
// import cat1 from "../assets/cat1.jpg"; // Kanjivaram
// import cat2 from "../assets/cat2.jpg"; // Anarkali / Festive
// import cat3 from "../assets/cat3.jpg"; // Bridal
...
//   return (
//     <section className="relative px-4 py-10 md:py-16 bg-[#F3F0ED]">
...
//                     {cat.subLabel}
//                   </p>
//                   <p className="text-xl md:text-2xl font-semibold">{cat.label}</p>
//                 </div>
//               </div>
//             </NavLink>
//           ))}
