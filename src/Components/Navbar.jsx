...
//                   const filterType = typeMap[key] || key.toLowerCase();
...
//                           const linkTo = `/collections/${hoveredCategory.cate_slug}/${filterType}/${itemSlug}`;
...
//                                       const linkTo = `/collections/${item.cate_slug}/${filterType}/${itemSlug}`;
