    ...
    <div className="bg-white min-h-screen">
      <div className="container mx-auto p-6 max-w-4xl">
        ...
        <div className="space-y-8 text-sm text-gray-700">
          <section>
            <p>
              This website is operated by Glamgait. Throughout the site, the
              terms “we”, “us” and “our” refer to Glamgait. Glamgait offers this
          ...
          <section className="space-y-2">
            ...
            <p>
              In no case shall Glamgait, our directors, officers, employees,
          ...
          <section className="space-y-2">
            ...
            <p>
              You agree to indemnify, defend and hold harmless Glamgait and our
